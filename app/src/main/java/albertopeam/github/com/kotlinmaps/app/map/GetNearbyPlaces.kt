 ...
 */
internal class GetNearbyPlaces(exceptionController: ExceptionController,
                      lifecycleOwner: LifecycleOwner,
                      private val nearbyPlacesService: NearbyPlacesService,
                      private val locationService: LocationService) : UseCase<Unit, List<Place>>(exceptionController, lifecycleOwner) {
     ...
     override fun run(args: Unit?): List<Place> {
         ...
         return nearbyPlacesService.nearby(targetLocation, radiusMeters, "AIzaSyBXfAzdkMfEKpa8Rsm7VwVSD6JHKa-hku0")
    }
